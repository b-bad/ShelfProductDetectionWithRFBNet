...
parser.add_argument('--mGPU', action='store_true', help='gpus')
...
args = parser.parse_args('--version RFB_E_vgg -s 512 -d VOC --max_epoch 300 -b 20 --num_workers 16 --mGPU'.split())


num_classes = (21, 81)[args.dataset == 'COCO']
if args.dataset == 'VOC':
    from data import VOCroot, VOC_300, VOC_512, AnnotationTransform, VOCDetection, detection_collate, BaseTransform, \
        preproc
...
if __name__ == '__main__':
    ...
    train()
    endTime = time.time()
    print('消耗时间:', (endTime - startTime) // 60, ' min ', (endTime - startTime) % 60, ' sec')
